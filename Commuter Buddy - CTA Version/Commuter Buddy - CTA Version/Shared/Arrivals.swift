...
class Arrivals: NSObject, NSCoding {
    ...
    required convenience init?(coder aDecoder: NSCoder) {
        ...
        self.init(route: route, stopDes: stopDes, finalTime: finalTime, isApproch: isApproch, isDly: isDly, trDr: trDr)
    }
    ...
    init(route: String, stopDes: String, finalTime: String, isApproch: String, isDly: String, trDr: String) {
        self.route = route
