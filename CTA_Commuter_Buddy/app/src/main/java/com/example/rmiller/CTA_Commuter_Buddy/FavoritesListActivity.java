    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        SwipeHelper swipeHelper2 = new SwipeHelper(FavoritesListActivity.this, favStations) {
            ...
            public void instantiateUnderlayButton(RecyclerView.ViewHolder viewHolder, List<UnderlayButton> underlayButtons) {
                underlayButtons.add(new SwipeHelper.UnderlayButton(getString(R.string.deleteButton), 0,
                        Color.parseColor(getString(R.string.deleteColor)), new SwipeHelper.UnderlayButtonClickListener() {
